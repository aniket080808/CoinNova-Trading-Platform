...
export default function Wallet() {
  ...
  const handledDepositRef = useRef(false);
  ...
  useEffect(() => {
    ...
    if (depositStatus === "success" && sessionId && mode === "live" && !handledDepositRef.current) {
      handledDepositRef.current = true;

      // Remove the query params immediately so a refresh doesn't replay the success toast.
