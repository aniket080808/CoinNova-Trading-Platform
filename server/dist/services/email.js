...
export async function sendVerificationEmail(to, otp) {
    return await sendMail(to, "Verify your CoinNova account", `
...
export async function sendPasswordResetEmail(to, otp) {
    return await sendMail(to, "Reset your CoinNova password", `
    <div style="font-family: system-ui, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #0a0a0f; color: #e4e4e7; border-radius: 16px;">
...
export async function sendTwoFactorEmail(to, otp) {
    return await sendMail(to, "Your CoinNova 2FA Code", `
    <div style="font-family: system-ui, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #0a0a0f; color: #e4e4e7; border-radius: 16px;">
...
export async function sendPinSetupEmail(to, otp) {
    return await sendMail(to, "Set your CoinNova Transaction PIN", `
    <div style="font-family: system-ui, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #0a0a0f; color: #e4e4e7; border-radius: 16px;">
...
export async function sendPinResetEmail(to, otp) {
    return await sendMail(to, "Reset your CoinNova Transaction PIN", `
    <div style="font-family: system-ui, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #0a0a0f; color: #e4e4e7; border-radius: 16px;">
...
export async function sendDepositConfirmation(to, amount) {
    return await sendMail(to, `Deposit of $${amount.toFixed(2)} confirmed`, `
    <div style="font-family: system-ui, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #0a0a0f; color: #e4e4e7; border-radius: 16px;">
...
export async function sendWithdrawalAlert(to, amount, dest) {
    return await sendMail(to, `Withdrawal of $${amount.toFixed(2)} initiated`, `
    <div style="font-family: system-ui, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #0a0a0f; color: #e4e4e7; border-radius: 16px;">
...
export async function sendPriceAlert(to, symbol, direction, price) {
    return await sendMail(to, `Price Alert: ${symbol.toUpperCase()} is ${direction} $${price.toLocaleString()}`, `
    <div style="font-family: system-ui, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #0a0a0f; color: #e4e4e7; border-radius: 16px;">
...
export async function sendEmailChangeEmail(to, otp) {
    return await sendMail(to, "Authorize Email Address Change", `
    <div style="font-family: system-ui, sans-serif; max-width: 480px; margin: 0 auto; padding: 32px; background: #0a0a0f; color: #e4e4e7; border-radius: 16px;">
